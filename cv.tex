...
%
 ...
 \explanationdetail{
  \coloredbullet\ %
 I built from scratch a novel optimisation procedure that operates on stabilized supralinear networks (SSNs) with multiple fixed-point attractors. The optimized networks display several relevant biological features, and can robustly store and recall memory states that correspond to population firing patterns. In my work, I modeled and tested these systems extensively, and compared them with state-of-the-art approaches used to construct attractor networks.\par
 }
%
 ...
 \explanationdetail{
  \coloredbullet\ %
 Recurrent neural networks (RNNs) can produce chaotic dynamical regimes. In this project,
starting from a RNN of quadratic integrate-and-fire neurons, I computed the so-called ``Lyapunov vectors'', that measure not only the presence of chaos, but also the direction and dimensionality of the most dynamically unstable dimensions. This allows for a more in-depth characterization of the ergodic properties of RNNs.\par
 }
 }

\section{Publications}
% \datedexperience{Structured stabilization in recurrent neural circuits through inhibitory synaptic plasticity}{2024}
    %
\datedexperience{Structured stabilization in recurrent neural circuits%
   through inhibitory synaptic plasticity}{2022}
   \explanation{\textbf{Dylan Festa}, Claudia Cusseddu, Julijana Gjorgjieva}
   \explanationdetail{BioRXiv %
   \href{https://doi.org/10.1101/2024.10.12.618014}{DOI: 10.1101/2024.10.12.618014}}
    %
...
\section{Teaching and supervision Experience} 
    ...
    \datedexperience{Computational neuroscience course}{2023,2024}
